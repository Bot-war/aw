...
[bold white]Hasil Crack[bold yellow] Cp[bold white] Tersimpan Di :[bold yellow] Results/Cp.txt""", title="[bold red]>[bold yellow]>[bold green]>[bold blue] (Hasil Crack) [bold green]<[bold yellow]<[bold red]"))
    ...
    def realme_useragent(self, total):
        for _ in range(total):
            ...
            self.android_version = random.choice(['4.2.2', '4.1.2', '4.3'])
            self.android_model = random.choice(['Redmi Note 3', 'LoveYou-2023', 'Basari-ID'])
            self.useragent = ('Mozilla/5.0 (Linux; U; Android 4.2.2; Redmi Note 3 Build/JZ054K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/36.0.4369.76 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; U; Android 4.1.2; LoveYou-2023 Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4264.105 Mobile Safari/537.36', 'Mozilla/5.0 (Linux;  Android 4.3; Basari-ID Lite) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/101.0.4414.94 Mobile Safari/537.36'.format(self.android_version, self.android_model, self.build, self.browser_version))
